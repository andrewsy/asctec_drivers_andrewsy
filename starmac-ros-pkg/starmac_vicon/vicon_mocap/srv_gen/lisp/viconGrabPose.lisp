...
(cl:defmethod cl:initialize-instance :after ((m <viconGrabPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'viconGrabPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_mocap-srv:<viconGrabPose-request> is deprecated: use vicon_mocap-srv:viconGrabPose-request instead.")))

(cl:ensure-generic-function 'subject_name-val :lambda-list '(m))
(cl:defmethod subject_name-val ((m <viconGrabPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-srv:subject_name-val is deprecated.  Use vicon_mocap-srv:subject_name instead.")
  (subject_name m))

(cl:ensure-generic-function 'segment_name-val :lambda-list '(m))
(cl:defmethod segment_name-val ((m <viconGrabPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-srv:segment_name-val is deprecated.  Use vicon_mocap-srv:segment_name instead.")
  (segment_name m))

(cl:ensure-generic-function 'n_measurements-val :lambda-list '(m))
(cl:defmethod n_measurements-val ((m <viconGrabPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-srv:n_measurements-val is deprecated.  Use vicon_mocap-srv:n_measurements instead.")
  (n_measurements m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<viconGrabPose-request>)))
  ...
  "vicon_mocap/viconGrabPoseRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'viconGrabPose-request)))
  "Returns string type for a service object of type 'viconGrabPose-request"
  "vicon_mocap/viconGrabPoseRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <viconGrabPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'viconGrabPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_mocap-srv:<viconGrabPose-response> is deprecated: use vicon_mocap-srv:viconGrabPose-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <viconGrabPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-srv:success-val is deprecated.  Use vicon_mocap-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <viconGrabPose-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-srv:pose-val is deprecated.  Use vicon_mocap-srv:pose instead.")
  (pose m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<viconGrabPose-response>)))
  ...
  "vicon_mocap/viconGrabPoseResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'viconGrabPose-response)))
  "Returns string type for a service object of type 'viconGrabPose-response"
  "vicon_mocap/viconGrabPoseResponse")
