...
(cl:defclass <Markers> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (markers
    :reader markers
    :initarg :markers
    :type (cl:vector vicon_mocap-msg:Marker)
   :initform (cl:make-array 0 :element-type 'vicon_mocap-msg:Marker :initial-element (cl:make-instance 'vicon_mocap-msg:Marker))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Markers>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Markers)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_mocap-msg:<Markers> is deprecated: use vicon_mocap-msg:Markers instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Markers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:header-val is deprecated.  Use vicon_mocap-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'frame_number-val :lambda-list '(m))
(cl:defmethod frame_number-val ((m <Markers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:frame_number-val is deprecated.  Use vicon_mocap-msg:frame_number instead.")
  (frame_number m))

(cl:ensure-generic-function 'markers-val :lambda-list '(m))
(cl:defmethod markers-val ((m <Markers>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:markers-val is deprecated.  Use vicon_mocap-msg:markers instead.")
  (markers m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Markers>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'markers)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'vicon_mocap-msg:Marker))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Markers>)))
  ...
  (cl:format cl:nil "Header header~%uint32 frame_number # Vicon Frame Number~%vicon_mocap/Marker[] markers # Array of Markers~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: vicon_mocap/Marker~%string marker_name~%string subject_name~%string segment_name~%geometry_msgs/Point translation~%bool occluded~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Markers)))
  "Returns full string definition for message of type 'Markers"
  (cl:format cl:nil "Header header~%uint32 frame_number # Vicon Frame Number~%vicon_mocap/Marker[] markers # Array of Markers~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.secs: seconds (stamp_secs) since epoch~%# * stamp.nsecs: nanoseconds since stamp_secs~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: vicon_mocap/Marker~%string marker_name~%string subject_name~%string segment_name~%geometry_msgs/Point translation~%bool occluded~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
