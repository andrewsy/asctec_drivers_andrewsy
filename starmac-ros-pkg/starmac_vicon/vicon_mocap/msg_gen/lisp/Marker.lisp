...
(cl:defmethod cl:initialize-instance :after ((m <Marker>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Marker)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name vicon_mocap-msg:<Marker> is deprecated: use vicon_mocap-msg:Marker instead.")))

(cl:ensure-generic-function 'marker_name-val :lambda-list '(m))
(cl:defmethod marker_name-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:marker_name-val is deprecated.  Use vicon_mocap-msg:marker_name instead.")
  (marker_name m))

(cl:ensure-generic-function 'subject_name-val :lambda-list '(m))
(cl:defmethod subject_name-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:subject_name-val is deprecated.  Use vicon_mocap-msg:subject_name instead.")
  (subject_name m))

(cl:ensure-generic-function 'segment_name-val :lambda-list '(m))
(cl:defmethod segment_name-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:segment_name-val is deprecated.  Use vicon_mocap-msg:segment_name instead.")
  (segment_name m))

(cl:ensure-generic-function 'translation-val :lambda-list '(m))
(cl:defmethod translation-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:translation-val is deprecated.  Use vicon_mocap-msg:translation instead.")
  (translation m))

(cl:ensure-generic-function 'occluded-val :lambda-list '(m))
(cl:defmethod occluded-val ((m <Marker>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader vicon_mocap-msg:occluded-val is deprecated.  Use vicon_mocap-msg:occluded instead.")
  (occluded m))
