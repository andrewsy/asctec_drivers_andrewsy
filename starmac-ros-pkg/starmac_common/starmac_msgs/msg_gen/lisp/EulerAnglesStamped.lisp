...
(cl:defclass <EulerAnglesStamped> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (angles
    :reader angles
    :initarg :angles
    :type starmac_msgs-msg:EulerAngles
    :initform (cl:make-instance 'starmac_msgs-msg:EulerAngles)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EulerAnglesStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EulerAnglesStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name starmac_msgs-msg:<EulerAnglesStamped> is deprecated: use starmac_msgs-msg:EulerAnglesStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <EulerAnglesStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:header-val is deprecated.  Use starmac_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'angles-val :lambda-list '(m))
(cl:defmethod angles-val ((m <EulerAnglesStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:angles-val is deprecated.  Use starmac_msgs-msg:angles instead.")
  (angles m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EulerAnglesStamped>)))
  ...
  "starmac_msgs/EulerAnglesStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EulerAnglesStamped)))
  "Returns string type for a message object of type 'EulerAnglesStamped"
  "starmac_msgs/EulerAnglesStamped")
