...
(cl:in-package starmac_msgs-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <EulerAngles>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EulerAngles)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name starmac_msgs-msg:<EulerAngles> is deprecated: use starmac_msgs-msg:EulerAngles instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:sequence-val is deprecated.  Use starmac_msgs-msg:sequence instead.")
  (sequence m))

(cl:ensure-generic-function 'angles_in_degrees-val :lambda-list '(m))
(cl:defmethod angles_in_degrees-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:angles_in_degrees-val is deprecated.  Use starmac_msgs-msg:angles_in_degrees instead.")
  (angles_in_degrees m))

(cl:ensure-generic-function 'ai-val :lambda-list '(m))
(cl:defmethod ai-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:ai-val is deprecated.  Use starmac_msgs-msg:ai instead.")
  (ai m))

(cl:ensure-generic-function 'aj-val :lambda-list '(m))
(cl:defmethod aj-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:aj-val is deprecated.  Use starmac_msgs-msg:aj instead.")
  (aj m))

(cl:ensure-generic-function 'ak-val :lambda-list '(m))
(cl:defmethod ak-val ((m <EulerAngles>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader starmac_msgs-msg:ak-val is deprecated.  Use starmac_msgs-msg:ak instead.")
  (ak m))
